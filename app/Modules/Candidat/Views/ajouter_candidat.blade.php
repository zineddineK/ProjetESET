                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="x_panel">
                            ...
                            <div class="animate x_conten">
                                ...
                                {!! Form::open(['method' => 'POST','url' => '/nouvel_candidat', 'class' => 'form-horizontal','files' => 'true' ]) !!}

                                {{ csrf_field() }}

                                <blockquote><i>Ce formulaire permet de créer le profil d'un(e) candidat(e)</i></blockquote>

                               <div class="clearfix">
                                          @if ($errors->count()>0)
                                          <div class="alert alert-danger">
                                            <strong>Candidat non ajouté, veuillez remplire les champs obligatoire (*) et verifier le format des champs</strong>
                                            <ul>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        {!! Form::text('nom_candidat', null, ['class' => 'form-control col-md-7 col-xs-12','placeholder' => 'Entrez votre nom']) !!}
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        {!! Form::text('prenom_candidat', null, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required', 'placeholder' => 'Entrez votre prénom']) !!}
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        {!! Form::text('email_candidat', null, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required', 'placeholder' => 'ex:example@example.com']) !!}
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        {!! Form::text('nbr_enfant', null, ['class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Entrez nombre d\'enfant'] ) !!}
