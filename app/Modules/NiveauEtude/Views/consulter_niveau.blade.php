                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="animate x_conten">
                            ...
                            {!! Form::open(['method' => 'POST','url' => '/modifier_niveau', 'class' => 'form-horizontal']) !!}
                           ...
                           <div class="clearfix">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    {!! Form::text('libelle_niveau', $niveau->libelle_niveau, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required','placeholder' => 'Niveau d\'études', 'disabled']) !!}
