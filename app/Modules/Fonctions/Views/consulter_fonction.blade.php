                        ...
                        <blockquote><i>Veuillez saisire toutes les informations qui concerne cette fonction</i></blockquote>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    {!! Form::text('libelle_fonction', $fonction-> libelle_fonction, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required','placeholder' => 'Fonctions', "disabled"]) !!}
