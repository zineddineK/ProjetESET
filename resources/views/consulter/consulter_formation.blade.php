  ...
  <div class="">
    ...
    <div class="x_panel">
      <div class="animate x_conten">
        {!! Form::open(['method' => 'POST', 'url' => '/nouvelle_formation', 'class' => 'form-horizontal form-label-left']) !!}
        {{ csrf_field() }}
        <blockquote><i>Toutes les informations qui concerne la formation : {{$formations->libelle_formation}}</i></blockquote>
        <div class="clearfix">
          @if ($errors->count()>0)
        ...
        <span class="section">Les informations de la formation</span>
        <div class="item form-group">
          {!! Form::label('inputname', 'Nom du formation ', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('libelle_formation', $formations->libelle_formation , ['class' => 'form-control col-md-7 col-xs-12', 'readonly' => 'readonly', 'placeholder' => 'Nom du formation']) !!}
          </div>
        </div>
         <div class="item form-group">
