  ...
  <div class="">
    ...
    <div class="x_panel">
      <div class="animate x_conten">
        ...
        {{ csrf_field() }}
        <blockquote><i>Veuillez saisire toutes les informations qui concerne ce projet : <b>{{$projets -> libelle_proj_pros}}</b></i></blockquote>
        <div class="clearfix">
          @if ($errors->count()>0)
        ...
        <div class="item form-group">
          {!! Form::label('inputname', 'Collaborateur *', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
            ...
            {!! Form::select('id_collaborateur', $collaborateurs , null,['class' => 'form-control col-md-7 col-xs-12','required' => 'required','placeholder' => 'Choisissez un collaborateur...']); !!}
          </div>
        </div>
        <div class="item form-group">
