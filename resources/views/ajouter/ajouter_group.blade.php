      ...
      <div class="animate x_conten">
        ...
        <div class="clearfix">
          ...
          <div class="alert alert-danger">
            <strong>Groupe non ajouter, veuillez remplire les champs obligatoire (*) et verifier le format des champs</strong>
            <ul>
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('libelle_gr', null, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required', 'placeholder' => 'Nom du groupe']) !!}
          </div>
        </div>
        <div class="item form-group">
          {!! Form::label('inputname', 'Abreviation du nom du groupe *', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('abreviation', null, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required', 'placeholder' => 'Abreviation']) !!}
          </div>
        </div>
         <div class="item form-group">
          {!! Form::label('inputname', 'Téléphone fixe *', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('telephone_fixe_gr', null, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required', 'placeholder' => 'Telephone fixe']) !!}
          </div>
        </div>
        <div class="item form-group">
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('email_gr', null, ['class' => 'form-control col-md-7 col-xs-12','required' =>'required', 'placeholder' => 'Adresse e-mail']) !!}
          </div>
        </div>
         <div class="item form-group">
          {!! Form::label('inputname', 'Nom du responsable *', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('responsable_gr', null, ['class' => 'form-control col-md-7 col-xs-12','required' =>'required', 'placeholder' => 'Nom du responsable']) !!}
          </div>
        </div>
         <div class="item form-group">
          {!! Form::label('inputname', 'Description *', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::textarea('description_gr', null, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required', 'placeholder' => 'Description du groupe']) !!}
          </div>
        </div>
