  ...
  <div class="">
    ...
    <div class="x_panel">
      <div class="animate x_conten">
        ...
        {{ csrf_field() }}
        <blockquote><i>Veuillez saisire toutes les informations qui concerne ce script</i></blockquote>
        <div class="clearfix">
          @if ($errors->count()>0)
        ...
        <div class="item form-group">
          {!! Form::label('inputname', 'Script *', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
           <div class="col-md-6 col-sm-6 col-xs-12">
              {!! Form::textarea('text_script', null, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required', 'placeholder' => 'Script']) !!}
            </div>
        </div>
