  ...
  <div class="">
    ...
    <div class="x_panel">
      <div class="animate x_conten">
        ...
        <span class="section">Les informations du formation</span>
        <div class="item form-group">
          {!! Form::label('inputname', 'Nom de formation *', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('libelle_formation', null, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required', 'placeholder' => 'Nom du formation']) !!}
          </div>
        </div>
        <div class="item form-group">
