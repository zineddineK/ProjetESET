  ...
  <div class="">
    ...
    <div class="x_panel">
      <div class="animate x_conten">
        {!! Form::open(['method' => 'PATCH', 'url' => route('concour.update',$concour), 'class' => 'form-horizontal form-label-left']) !!}
        {{ csrf_field() }}
        <blockquote><i>Veuillez modifier toutes les informations qui concerne ce concour :</i> {{$concour->libelle_concour}}</blockquote>
        <div class="clearfix">
          @if ($errors->count()>0)
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('libelle_concour', $concour->libelle_concour , ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required', 'placeholder' => 'Nom du concour']) !!}
          </div>
        </div>
        ...
        <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::date('date_concour', $concour->date_concour , ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required', 'placeholder' => 'Date du concour']) !!}
          </div>
        </div>
         <div class="item form-group">
          {!! Form::label('inputname', 'Heure du concour *', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::time('heure_concour', $concour->heure_concour , ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required', 'placeholder' => 'Date du concour']) !!}
          </div>
        </div>
